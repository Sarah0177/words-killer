import { d as useState, c as _sfc_main$f, a as useLocale, b as useAppConfig, t as tv } from './server.mjs';
import { defineComponent, ref, computed, mergeProps, unref, withCtx, createTextVNode, createVNode, toDisplayString, watch, createBlock, createCommentVNode, openBlock, Fragment, renderList, renderSlot, useSSRContext } from 'vue';
...
_sfc_main$1.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.2.1_@babel+parse_bec1c26f5da3e0eb7eb8934493334778/node_modules/@nuxt/ui/dist/runtime/components/Carousel.vue");
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "p-6" }, _attrs))}><h1> 共${ssrInterpolate(unref(toKillList).length)}只小怪兽`);
      ...
      _push(`</h1><div class="w-full mt-6"><div>`);
      _push(ssrRenderComponent(_component_UCarousel, {
        arrows: "",
        items: unref(toKillList),
        class: "w-full max-w-xs mx-auto"
      }, {
        default: withCtx(({ item }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="mx-auto w-[180px] h-[180px] rounded-full bg-primary text-4xl text-white flex justify-center items-center"${_scopeId}>${ssrInterpolate(item.content)}</div>`);
          } else {
            return [
              createVNode("div", { class: "mx-auto w-[180px] h-[180px] rounded-full bg-primary text-4xl text-white flex justify-center items-center" }, toDisplayString(item.content), 1)
            ];
          }
        }),
        _: 1
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/kill/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=index-Dg_Y4a4L.mjs.map
