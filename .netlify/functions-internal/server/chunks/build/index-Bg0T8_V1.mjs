import { defineComponent, ref, computed, mergeProps, withCtx, createTextVNode, useSlots, useTemplateRef, watch, nextTick, unref, createVNode, renderSlot, createBlock, createCommentVNode, openBlock, useSSRContext } from 'vue';
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderSlot, ssrRenderClass } from 'vue/server-renderer';
import { Primitive } from 'reka-ui';
import { useVModel } from '@vueuse/core';
import { c as _sfc_main$f, b as useAppConfig, e as useFormField, f as useComponentIcons, t as tv, g as _sfc_main$k, h as _sfc_main$i, d as useState, l as looseToNumber } from './server.mjs';
import '../_/nitro.mjs';
import 'node:http';
import 'node:https';
import 'node:events';
...
const _sfc_main$1 = /* @__PURE__ */ Object.assign({ inheritAttrs: false }, {
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const { emitFormFocus, emitFormBlur, emitFormInput, emitFormChange, size, color, id, name, highlight, disabled, ariaAttrs } = useFormField(props, {});
...
_sfc_main$1.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.2.1_@babel+parse_bec1c26f5da3e0eb7eb8934493334778/node_modules/@nuxt/ui/dist/runtime/components/Textarea.vue");
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "px-8 py-4 mx-auto lg:w-4xl md:w-2xl" }, _attrs))}>`);
      _push(ssrRenderComponent(_component_UTextarea, {
        class: "w-full",
        autoresize: "",
        modelValue: addVal.value,
        "onUpdate:modelValue": ($event) => addVal.value = $event,
      ...
      _push(`</div><div>${ssrInterpolate(addList.value.join(" / "))}</div>`);
      if (addList.value.length > 0) {
        _push(`<div>共输入${ssrInterpolate(addList.value.length)}个单词</div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/add/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=index-Bg0T8_V1.mjs.map
